...
Free services sleep after idle traffic and can take about one minute to wake. Frontend SSR authentication waits up to 90 seconds with a 120-second page duration budget. No keep-alive job, paid workspace feature or additional service is used. See https://render.com/docs/free.
